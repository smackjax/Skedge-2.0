import { objToArr, arrToObj } from '../../functions';
...
export const formatSchedByMember = (vanillaSched)=>{
    // Gets all dates
  ...
  export const formatSchedByDate = (vanillaSched)=>{
        const arrayDateSched = toArrays(vanillaSched.sched, 'tasks', 'assigned');
